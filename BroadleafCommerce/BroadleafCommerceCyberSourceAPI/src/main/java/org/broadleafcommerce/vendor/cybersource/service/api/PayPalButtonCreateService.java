/**
 * PayPalButtonCreateService.java
 *
...
public class PayPalButtonCreateService  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PayPalButtonCreateService)) return false;
        PayPalButtonCreateService other = (PayPalButtonCreateService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PayPalButtonCreateService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.49", "PayPalButtonCreateService"));
