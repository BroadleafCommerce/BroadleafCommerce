...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/category.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/category_xref.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/category_product_xref.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/sku.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product_sku_xref.txt' 
INTO TABLE broadleafcommerce.BLC_PRODUCT_SKU_XREF
FIELDS TERMINATED BY '|' ENCLOSED BY ""; 

DELETE FROM broadleafcommerce.BLC_PRODUCT_ATTRIBUTE;

LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product_attribute.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product_image.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/sequence_generator.txt' 
INTO TABLE broadleafcommerce.SEQUENCE_GENERATOR
FIELDS TERMINATED BY '|' ENCLOSED BY "";

DELETE FROM broadleafcommerce.BLC_COUNTRY;

LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/country.txt' 
INTO TABLE broadleafcommerce.BLC_COUNTRY
FIELDS TERMINATED BY '|' ENCLOSED BY "";

DELETE FROM broadleafcommerce.BLC_STATE;

LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/state.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/shipping_rate.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/customer.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/customer_phone.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/phone.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/challenge_question.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product_cross_sale.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product_up_sale.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/store.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/zipCode.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/product_featured.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/category_image.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/offer.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/offer_code.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/rating_summary.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/review_detail.txt' 
...
LOAD DATA INFILE '/Java_Projects/dev/credera/BroadleafCommerce/BroadleafCommerceDemo/config/mysql/rating_detail.txt' 
