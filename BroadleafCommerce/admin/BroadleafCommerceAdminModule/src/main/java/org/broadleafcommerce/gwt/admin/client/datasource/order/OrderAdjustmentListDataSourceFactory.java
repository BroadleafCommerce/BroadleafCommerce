...
public class OrderAdjustmentListDataSourceFactory {
	...
	public static void createDataSource(String name, AsyncCallback<DataSource> cb) {
		if (dataSource == null) {
			...
			DataSourceModule[] modules = new DataSourceModule[]{
				new BasicEntityModule(CeilingEntities.ORDER_ADJUSTMENT, persistencePerspective, AppServices.DYNAMIC_ENTITY)
			};
