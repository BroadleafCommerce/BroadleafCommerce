package org.broadleafcommerce.gwt.client.datasource.promotion.offercode;
...
public class OfferCodeListDataSourceFactory {
	...
	public static void createDataSource(String name, AsyncCallback<DataSource> cb) {
		if (dataSource == null) {
			...
			PersistencePerspective persistencePerspective = new PersistencePerspective(operationTypes, new String[]{}, new ForeignKey[]{new ForeignKey("offer", EntityImplementations.OFFER, null)});
