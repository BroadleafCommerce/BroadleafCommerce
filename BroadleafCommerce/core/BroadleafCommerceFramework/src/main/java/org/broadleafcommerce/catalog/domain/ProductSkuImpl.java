...
public class ProductSkuImpl extends ProductImpl implements ProductSku {
	...
	/* (non-Javadoc)
	 * @see org.broadleafcommerce.catalog.domain.ProductSku#getSku()
	 */
	public Sku getSku() {
		return sku;
	}
	...
	/* (non-Javadoc)
	 * @see org.broadleafcommerce.catalog.domain.ProductSku#setSku(org.broadleafcommerce.catalog.domain.Sku)
	 */
