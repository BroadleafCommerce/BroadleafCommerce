...
public class EmailTrackingClicksImpl implements EmailTrackingClicks {
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#getId()
     */
    public Long getId() {
        return id;
    }
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#setId(java.lang.Long)
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#getDateClicked()
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#setDateClicked(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#getDestinationUri()
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#setDestinationUri(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#getQueryString()
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#setQueryString(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#getEmailTracking()
     */
    ...
    /* (non-Javadoc)
     * @see org.broadleafcommerce.profile.email.domain.EmailTrackingClicks#setEmailTracking(org.broadleafcommerce.profile.email.domain.EmailTrackingImpl)
     */
