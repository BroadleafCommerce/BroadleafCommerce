...
package org.broadleafcommerce.admin.cms.commands.contentCreation
{
	...
	public class ReadAllContentPageInfosCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent):void
		{
			var rpi:ReadAllContentPageInfosEvent = event as ReadAllContentPageInfosEvent;
			var delegate:ContentServiceDelegate = new ContentServiceDelegate(this);
			delegate.readAllContentPageInfos();
		...
		public function result(data:Object):void
		{
			...
			var parentList:ArrayCollection = event.result as ArrayCollection;

			ContentModelLocator.getInstance().contentModel.parentUrlList = parentList;
		}
