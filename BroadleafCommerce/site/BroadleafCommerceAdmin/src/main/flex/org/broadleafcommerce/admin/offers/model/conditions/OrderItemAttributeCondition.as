...
package org.broadleafcommerce.admin.offers.model.conditions
{
	...
	{
		private const _operatorLabel:String = "Order Item attribute is. . .";
		private const _conditionLabelBegin:String = "orderItem.";
		...
		{
			var oac:OrderItemAttributeCondition = new OrderItemAttributeCondition();
			return oac;
		}
