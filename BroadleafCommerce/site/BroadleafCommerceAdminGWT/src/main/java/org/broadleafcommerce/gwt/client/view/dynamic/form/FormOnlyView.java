...
public class FormOnlyView extends VLayout implements FormOnlyDisplay {
	...
	public FormOnlyView(DataSource dataSource) {
        ...
        if (dataSource != null) {
        	buildFields(dataSource, true, true);
        }
        addMember(form);
        setOverflow(Overflow.AUTO);
	}

	public void buildFields(final DataSource dataSource, Boolean showDisabledState, Boolean canEdit) {
