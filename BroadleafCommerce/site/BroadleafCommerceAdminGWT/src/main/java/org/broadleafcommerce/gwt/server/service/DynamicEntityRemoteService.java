package org.broadleafcommerce.gwt.server.service;
...
public class DynamicEntityRemoteService implements DynamicEntityService, InspectHelper {
	...
	public DynamicResultSet inspect(String ceilingEntityFullyQualifiedClassname, PersistencePerspective persistencePerspective, String[] customCriteria, Map<String, FieldMetadata> metadataOverrides) throws ServiceException {
		try {
