...
INSERT INTO BLC_PRODUCT (PRODUCT_ID,DEFAULT_CATEGORY_ID,NAME,LONG_DESCRIPTION,IS_FEATURED_PRODUCT,IS_MACHINE_SORTABLE,WIDTH,HEIGHT,DEPTH,MANUFACTURE,MODEL,WEIGHT,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (171,2001,'Jura - IMPRESSA J5','The IMPRESSA J5 is Jura�s first compact automatic coffee center expressing a new design philosophy. Smooth, clean lines, elegant accents, and an all-encompassing attention to detail make the J5 an aesthetic masterpiece from any angle. High-end material',1,1,13.6,11,17.1,'Jura','13333',22,'2020-01-01',CURRENT_DATE);
