...
INSERT INTO BLC_PRODUCT (PRODUCT_ID,DEFAULT_CATEGORY_ID,NAME,LONG_DESCRIPTION,IS_FEATURED_PRODUCT,IS_MACHINE_SORTABLE,WIDTH,HEIGHT,DEPTH,MANUFACTURE,MODEL,WEIGHT,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (171,2001,'Jura - IMPRESSA J5','The IMPRESSA J5 is Jura�s first compact automatic coffee center expressing a new design philosophy. Smooth, clean lines, elegant accents, and an all-encompassing attention to detail make the J5 an aesthetic masterpiece from any angle. High-end material',1,1,13.6,11,17.1,'Jura','13333',22,'2020-01-01',DATEADD(D, 0, DATEDIFF(D, 0, GETDATE())));
...
INSERT INTO BLC_PRODUCT (PRODUCT_ID,DEFAULT_CATEGORY_ID,NAME,LONG_DESCRIPTION,IS_FEATURED_PRODUCT,IS_MACHINE_SORTABLE,WIDTH,HEIGHT,DEPTH,MANUFACTURE,MODEL,WEIGHT,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (174,2001,'Jura - IMPRESSA Z6','Add luxury to perfection! Grand curved high-gloss chrome plated-plated aluminum front. High-polished mirrored LED display (the LED information �shines� through the mirror finish). Hand-polished, oversized, drip tray made of die-cast zinc (weighs almost',0,1,12.2,14.5,17.1,'Jura','13299',31.5,'2020-01-01',DATEADD(D, 0, DATEDIFF(D, 0, GETDATE())));
...
INSERT INTO BLC_PRODUCT (PRODUCT_ID,DEFAULT_CATEGORY_ID,NAME,LONG_DESCRIPTION,IS_FEATURED_PRODUCT,IS_MACHINE_SORTABLE,WIDTH,HEIGHT,DEPTH,MANUFACTURE,MODEL,WEIGHT,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (178,2007,'Bodum - Antigua','Freshly ground coffee makes all the difference when brewing the perfect cup! Just like professional-grade coffee grinders, BODUM�s Antigua electric coffee grinder features a conical burr grinder that cuts the coffee beans rather than crushing them, pre',0,1,NULL,NULL,NULL,'Bodum','10462-01USA',7,'2020-01-01',DATEADD(D, 0, DATEDIFF(D, 0, GETDATE())));
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (145,'Jura - Capresso Impressa Z5 Espresso Machine Kit','This super automatic espresso machine lets you go from whole beans to superb espresso and any size cappuccino or latte with one-touch convenience. Programmable brewing buttons let you select your coffeeâs size, strength and temperature. Built-in comme',182.99,182.99,'N','N','2020-01-01',DATEADD(D, 0, DATEDIFF(D, 0, GETDATE())));
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (146,'Pasquini - Livietta Espresso Machine Kit','Compact and semi-automatic, Pasquini''s latest commercial machine for the home fits beautifully in almost any size kitchen. New thermoblock technology lets you steam milk and brew espresso at the same timeâmaking it ideal for entertaining. Use with illy',151.99,151.99,'N','N','2020-01-01',DATEADD(D, 0, DATEDIFF(D, 0, GETDATE())));
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (171,'Jura - IMPRESSA J5','The IMPRESSA J5 is Juraâs first compact automatic coffee center expressing a new design philosophy. Smooth, clean lines, elegant accents, and an all-encompassing attention to detail make the J5 an aesthetic masterpiece from any angle. High-end materia',172.99,170.99,'N','N','2020-01-01',DATEADD(D, 0, DATEDIFF(D, 0, GETDATE())));
