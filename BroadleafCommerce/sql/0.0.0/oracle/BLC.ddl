...
CREATE TABLE BLC_PRODUCT (
  ...
  HEIGHT                    number(19, 2), 
  GIRTH                     number(19, 2), 
  CONTAINER_SIZE            varchar2(150), 
  CONTAINER_SHAPE           varchar2(150), 
  IS_MACHINE_SORTABLE       number, 
  WEIGHT_UNIT_OF_MEASURE    varchar2(150), 
  DIMENSION_UNIT_OF_MEASURE varchar2(150), 
...
CREATE TABLE BLC_PRODUCT_UP_SALE (
  UP_SALE_PRODUCT_ID      number(19) NOT NULL, 
  PRODUCT_ID              number(19), 
  RELATED_SALE_PRODUCT_ID number(19), 
  PROMOTION_MESSAGE       varchar2(255), 
  SEQUENCE                number(19), 
