...
DROP TABLE blc_candidate_fulfillment_group_offer;
DROP TABLE blc_order_adjustment;
DROP TABLE blc_order_item_adjustment;
DROP TABLE blc_fulfillment_group_adjustment;
...
(
  ...
  CONSTRAINT FK_CUSTOMER_ORDER_PAYMENT FOREIGN KEY (CUSTOMER_ID) REFERENCES blc_customer(CUSTOMER_ID)
);
...
(
  ...
  APPLY_OFFER_TO_MARKED_ITEMS VARCHAR2(255),
...
(
  ...
  CONSTRAINT FK_CANDIDATE_ORDER_OFFER_ORDER_fk FOREIGN KEY (ORDER_ID) REFERENCES blc_order(ORDER_ID),
  CONSTRAINT FK_CANDIDATE_ORDER_OFFER_OFFER_fk FOREIGN KEY (OFFER_ID) REFERENCES blc_offer(OFFER_ID)
};
...
(
  ...
  CONSTRAINT FK_CANDIDATE_ITEM_OFFER_ORDER_ITEM_fk FOREIGN KEY (ORDER_ITEM_ID) REFERENCES blc_order_item(ORDER_ITEM_ID),
  CONSTRAINT FK_CANDIDATE_ITEM_OFFER_OFFER_fk FOREIGN KEY (OFFER_ID) REFERENCES blc_offer(OFFER_ID)
};

----------------------------------------
-- blc_candidate_fulfillment_group_offer
----------------------------------------
CREATE TABLE blc_candidate_fulfillment_group_offer
(
  CANDIDATE_FULFILLMENT_GROUP_OFFER_ID NUMBER(19,0) NOT NULL,
  FULFILLMENT_GROUP_ID NUMBER(19,0) NOT NULL,
  OFFER_ID NUMBER(19,0) NOT NULL,
  DISCOUNTED_PRICE NUMBER(12,2),
  CONSTRAINT PK_BLC_CANDIDATE_FULFILLMENT_GROUP_OFFER PRIMARY KEY(CANDIDATE_FULFILLMENT_GROUP_OFFER_ID) USING INDEX TABLESPACE WEB_IDX1,
  CONSTRAINT FK_CANDIDATE_FULFILLMENT_GROUP_OFFER_FULFILLMENT_GROUP_fk FOREIGN KEY (FULFILLMENT_GROUP_ID) REFERENCES blc_fulfillment_group(FULFILLMENT_GROUP_ID),
  CONSTRAINT FK_CANDIDATE_FULFILLMENT_GROUP_OFFER_OFFER_fk FOREIGN KEY (OFFER_ID) REFERENCES blc_offer(OFFER_ID)
};
...
(
  ...
  CONSTRAINT FK_ORDER_ADJUSTMENT_ORDER_ITEM_fk FOREIGN KEY (ORDER_ITEM_ID) REFERENCES blc_order_item(ORDER_ITEM_ID),
  CONSTRAINT FK_ORDER_ADJUSTMENT_OFFER_fk FOREIGN KEY (OFFER_ID) REFERENCES blc_offer(OFFER_ID)
};
...
------------------------------------
CREATE TABLE blc_fulfillment_group_adjustment
(
  FULFILLMENT_GROUP_ADJUSTMENT_ID NUMBER(19,0) NOT NULL,
  FULFILLMENT_GROUP_ID NUMBER(19,0) NOT NULL,
  OFFER_ID NUMBER(19,0) NOT NULL,
  ADJUSTMENT_REASON VARCHAR2(255),
  ADJUSTMENT_VALUE NUMBER(12,2),
  CONSTRAINT PK_BLC_FULFILLMENT_GROUP_ADJUSTMENT PRIMARY KEY(FULFILLMENT_GROUP_ADJUSTMENT_ID) USING INDEX TABLESPACE WEB_IDX1,
  CONSTRAINT FK_FULFILLMENT_GROUP_ADJUSTMENT_FULFILLMENT_GROUP_fk FOREIGN KEY (FULFILLMENT_GROUP_ID) REFERENCES blc_fulfillment_group(FULFILLMENT_GROUP_ID),
  CONSTRAINT FK_FULFILLMENT_GROUP_ADJUSTMENT_OFFER_fk FOREIGN KEY (OFFER_ID) REFERENCES blc_offer(OFFER_ID)
};
...
(
  ...
  CONSTRAINT FK_ORDER_OFFER_CODE_ORDER_fk FOREIGN KEY (ORDER_ID) REFERENCES blc_order(ORDER_ID),
  CONSTRAINT FK_ORDER_OFFER_CODE_OFFER_CODE_fk FOREIGN KEY (OFFER_CODE_ID) REFERENCES blc_offer_code(OFFER_CODE_ID)
};
...
(
  ...
  CONSTRAINT FK_CUSTOMER_OFFER_CUSTOMER_fk FOREIGN KEY (CUSTOMER_ID) REFERENCES blc_customer(CUSTOMER_ID),
  CONSTRAINT FK_CUSTOMER_OFFER_OFFER_fk FOREIGN KEY (OFFER_ID) REFERENCES blc_offer(OFFER_ID)
};
