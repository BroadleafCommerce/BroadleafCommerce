 ...
 * @author jfischer
 */
public class USPSContainerShapeType implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final Map<String, USPSContainerShapeType> types = new Hashtable<String, USPSContainerShapeType>();
    ...
    public static USPSContainerShapeType getInstance(String type) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        USPSContainerShapeType other = (USPSContainerShapeType) obj;
        if (type == null) {
            if (other.type != null)
                return false;
