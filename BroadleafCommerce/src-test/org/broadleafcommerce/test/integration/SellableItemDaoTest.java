...
public class SellableItemDaoTest extends BaseTest {
    ...
    @Test(groups = {"createSellableItem"},dataProvider="basicSellableItem", dataProviderClass=SellableItemDaoDataProvider.class, dependsOnGroups={"readCustomer1","createOrder","createCatalogItem"})
    @Rollback(false)
