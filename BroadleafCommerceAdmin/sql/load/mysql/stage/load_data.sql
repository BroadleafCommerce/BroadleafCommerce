...
LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/category.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/product.txt' 
...
(PRODUCT_ID, DEFAULT_CATEGORY_ID, NAME, DESCRIPTION)
  ...
  IS_MACHINE_SORTABLE = TRUE;
  
DELETE FROM broadleafcommerce.BLC_CATEGORY_XREF;

LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/category_xref.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/category_product_xref.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/sku.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/product_sku_xref.txt' 
INTO TABLE broadleafcommerce.BLC_PRODUCT_SKU_XREF
FIELDS TERMINATED BY '|' ENCLOSED BY ""; 

DELETE FROM broadleafcommerce.BLC_PRODUCT_ATTRIBUTE;

LOAD DATA INFILE 'C:\\dev\\workspaces\\BroadleafCommerce\\BroadleafCommerceAdmin/sql/load/mysql/product_attribute.txt' 
