...
public class PayPalPaymentReply  implements java.io.Serializable {
    private java.math.BigInteger reasonCode;

    private java.lang.String secureData;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PayPalPaymentReply)) return false;
        PayPalPaymentReply other = (PayPalPaymentReply) obj;
        ...
        _equals = true && 
            ...
            ((this.secureData==null && other.getSecureData()==null) || 
             (this.secureData!=null &&
              this.secureData.equals(other.getSecureData()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSecureData() != null) {
            _hashCode += getSecureData().hashCode();
        }
        if (getAmount() != null) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PayPalPaymentReply.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.49", "PayPalPaymentReply"));
        ...
        elemField.setFieldName("secureData");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.49", "secureData"));
