...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/category.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/category_xref.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/category_product_xref.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/sku.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product_sku_xref.txt' 
INTO TABLE broadleafcommerce.BLC_PRODUCT_SKU_XREF
FIELDS TERMINATED BY '|' ENCLOSED BY ""; 

DELETE FROM broadleafcommerce.BLC_PRODUCT_ATTRIBUTE;

LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product_attribute.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product_image.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/sequence_generator.txt' 
INTO TABLE broadleafcommerce.SEQUENCE_GENERATOR
FIELDS TERMINATED BY '|' ENCLOSED BY "";

DELETE FROM broadleafcommerce.BLC_COUNTRY;

LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/country.txt' 
INTO TABLE broadleafcommerce.BLC_COUNTRY
FIELDS TERMINATED BY '|' ENCLOSED BY "";

DELETE FROM broadleafcommerce.BLC_STATE;

LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/state.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/shipping_rate.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/customer.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/customer_phone.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/phone.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/challenge_question.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product_cross_sale.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product_up_sale.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/store.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/zipCode.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/product_featured.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/category_image.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/offer.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/offer_code.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/rating_summary.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/review_detail.txt' 
...
LOAD DATA INFILE 'C:\\dev\\workspaces\\credera\\BroadleafCommerceDemo/sql/load/mysql/rating_detail.txt' 
