...
public class PageTemplateFormListDataSourceFactory {
	...
	public static DynamicEntityDataSource createDataSource(String name, String[] customCriteria, AsyncCallback<DataSource> cb) {
        ...
        DynamicEntityDataSource dataSource = new DynamicEntityDataSource(name + count++, persistencePerspective, AppServices.DYNAMIC_ENTITY, modules);
