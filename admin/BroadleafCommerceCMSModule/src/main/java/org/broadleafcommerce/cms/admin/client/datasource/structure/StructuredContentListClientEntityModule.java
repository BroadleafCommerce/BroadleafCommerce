...
public class StructuredContentListClientEntityModule extends BasicClientEntityModule {
    ...
    public StructuredContentListClientEntityModule(String ceilingEntityFullyQualifiedClassname, PersistencePerspective persistencePerspective, DynamicEntityServiceAsync service, Map<String, FieldMetadata> metadataOverrides) {
