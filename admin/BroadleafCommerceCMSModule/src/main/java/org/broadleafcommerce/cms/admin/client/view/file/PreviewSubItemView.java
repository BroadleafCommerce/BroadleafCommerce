 ...
 *
 */
public class PreviewSubItemView extends VLayout implements PreviewSubItemDisplay {
    ...
    public PreviewSubItemView(String title, Boolean canReorder, Boolean canEdit) {
        this(title, canReorder, canEdit, false);
    }

	public PreviewSubItemView(String title, Boolean canReorder, Boolean canEdit, Boolean showFilterEditor) {
        setHeight100();
        setWidth100();
        ...
        previewLayout.setBackgroundColor("#eaeaea");
        previewLayout.setWidth100();
        formOnlyView = new FormOnlyView();
        previewLayout.addMember(formOnlyView);

        previewContainer = new PreviewContainer();
        previewContainer.setVisible(false);
        previewLayout.addMember(previewContainer);
