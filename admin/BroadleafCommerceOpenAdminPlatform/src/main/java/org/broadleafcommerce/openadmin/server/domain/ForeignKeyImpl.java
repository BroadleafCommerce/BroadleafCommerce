...
public class ForeignKeyImpl implements PersistencePerspectiveItem, ForeignKey {

	private static final long serialVersionUID = 1L;
	
	@Id
    @GeneratedValue(generator = "ForeignKeyId", strategy = GenerationType.TABLE)
    @TableGenerator(name = "ForeignKeyId", table = "SEQUENCE_GENERATOR", pkColumnName = "ID_NAME", valueColumnName = "ID_VAL", pkColumnValue = "ForeignKeyImpl", allocationSize = 50)
