 ...
 *
 */
public class DefaultSkuMediaMapDataSourceFactory implements DataSourceFactory {
	
	public static final MapStructure MAPSTRUCTURE = new MapStructure(String.class.getName(), "key", "Key", EntityImplementations.MEDIA, "skuMedia", true);
	public static ComplexValueMapStructureDataSource dataSource = null;
	
	protected OneToOneProductSkuPresenter presenter;
	
	public DefaultSkuMediaMapDataSourceFactory(OneToOneProductSkuPresenter presenter) {
