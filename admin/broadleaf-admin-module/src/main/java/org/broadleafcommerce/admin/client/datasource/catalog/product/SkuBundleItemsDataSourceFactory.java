...
public class SkuBundleItemsDataSourceFactory implements DataSourceFactory {
    ...
    public void createDataSource(String name, OperationTypes operationTypes, Object[] additionalItems, AsyncCallback<DataSource> cb) {
        if (dataSource == null) {
            ...
            persistencePerspective.addPersistencePerspectiveItem(PersistencePerspectiveItemType.JOINSTRUCTURE, new JoinStructure(symbolName, linkedObjectPath, linkedIdProperty, targetObjectPath, targetIdProperty, EntityImplementations.SKU_BUNDLE_ITEM));
            DataSourceModule[] modules = new DataSourceModule[]{
                new BasicClientEntityModule(CeilingEntities.SKU, persistencePerspective, AppServices.DYNAMIC_ENTITY),
                new JoinStructureClientModule(CeilingEntities.SKU, persistencePerspective, AppServices.DYNAMIC_ENTITY)
            };
