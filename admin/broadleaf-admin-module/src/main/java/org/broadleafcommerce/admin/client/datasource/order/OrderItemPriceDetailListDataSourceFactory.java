 ...
 *
 */
public class OrderItemPriceDetailListDataSourceFactory implements DataSourceFactory {
    ...
    public void createDataSource(String name, OperationTypes operationTypes, Object[] additionalItems, AsyncCallback<DataSource> cb) {
        if (dataSource == null) {
            ...
            DataSourceModule[] modules = new DataSourceModule[]{
                    new BasicClientEntityModule(CeilingEntities.ORDER_ITEM_PRICE_DETAIL, persistencePerspective, AppServices.DYNAMIC_ENTITY)
            };
