...
/**
 * Handles admin operations for the {@link Customer} entity.
 * 
 * @author Andre Azzolini (apazzolini)
 */
@Controller("blAdminCustomerController")
@RequestMapping("/" + AdminCustomerController.SECTION_KEY)
public class AdminCustomerController extends AdminBasicEntityController {
    ...
    @Resource(name = "blAdminCustomerControllerExtensionManager")
    protected AdminCustomerControllerExtensionManager extensionManager;
    ...
    protected void modifyModelAttributes(Model model) {
        ...
        extensionManager.getProxy().modifyEntityForm(ef);
    }
