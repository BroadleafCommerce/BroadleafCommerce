...
public class FulfillmentGroupFieldServiceImpl  extends AbstractRuleBuilderFieldService {
    ...
    public void init() {
        fields.add(new FieldData.Builder()
                ...
                .build());
        fields.add(new FieldData.Builder()
                .label("Fulfillment Group - Last Name")
                ...
                .build());
        fields.add(new FieldData.Builder()
                .label("Fulfillment Group - Address Line 1")
                ...
                .build());
        fields.add(new FieldData.Builder()
                .label("Fulfillment Group - Address Line 2")
        ...
        fields.add(new FieldData.Builder()
                ...
                .build());
        fields.add(new FieldData.Builder()
                .label("Fulfillment Group - County")
                .name("address.county")
                .operators("blcOperators_Text")
                .options("[]")
                .type(SupportedFieldType.STRING)
        ...
        fields.add(new FieldData.Builder()
                ...
                .build());
        fields.add(new FieldData.Builder()
                .label("Fulfillment Group - Postal Code")
                ...
                .build());
        fields.add(new FieldData.Builder()
                .label("Fulfillment Group - Country")
