...
public class CeilingEntities {
    ...
    public static final String TIMEDTO = "org.broadleafcommerce.common.time.TimeDTO";
    public static final String REQUESTDTO = "org.broadleafcommerce.common.time.RequestDTOImpl";
