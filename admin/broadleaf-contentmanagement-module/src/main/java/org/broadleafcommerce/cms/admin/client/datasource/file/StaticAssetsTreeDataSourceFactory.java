...
import org.broadleafcommerce.cms.admin.client.datasource.file.module.StaticAssetsListClientyEntityModule;
	...
	public void createDataSource(String name, OperationTypes operationTypes, Object[] additionalItems, AsyncCallback<DataSource> cb) {
		if (dataSource == null) {
			...
			DataSourceModule[] modules = new DataSourceModule[]{
				new StaticAssetsListClientyEntityModule(CeilingEntities.STATICASSETS, persistencePerspective, AppServices.DYNAMIC_ENTITY)
			};
