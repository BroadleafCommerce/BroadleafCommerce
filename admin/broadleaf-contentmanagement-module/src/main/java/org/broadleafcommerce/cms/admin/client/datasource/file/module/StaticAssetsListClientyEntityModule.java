 ...
 * @author jfischer
 */
public class StaticAssetsListClientyEntityModule extends BasicClientEntityModule {

    public StaticAssetsListClientyEntityModule(String ceilingEntityFullyQualifiedClassname, PersistencePerspective persistencePerspective, DynamicEntityServiceAsync service) {
