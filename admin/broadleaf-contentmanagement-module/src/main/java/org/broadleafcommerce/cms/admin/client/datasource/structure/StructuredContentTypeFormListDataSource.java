 ...
 * Created by jfischer
 */
public class StructuredContentTypeFormListDataSource extends DynamicEntityDataSource {

    protected String[] customCriteria;

    public StructuredContentTypeFormListDataSource(String name, PersistencePerspective persistencePerspective, DynamicEntityServiceAsync service, DataSourceModule[] modules) {
