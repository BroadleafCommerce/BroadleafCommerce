...
public class PagesView extends HLayout implements Instantiable, PagesDisplay {
    ...
    protected ToolStripButton pageSaveButton;
    protected ToolStripButton pageRefreshButton;
    ...
    public void build(DataSource entityDataSource, DataSource... additionalDataSources) {
        ...
        pageSaveButton = new ToolStripButton();
        pageSaveButton.setIcon(GWT.getModuleBaseURL()+"admin/images/button/save.png");
        pageSaveButton.setTitle(BLCMain.getMessageManager().getString("saveTitle"));
        structuredContentToolBar.addButton(pageSaveButton);
        pageSaveButton.setDisabled(true);
        pageRefreshButton = new ToolStripButton();
        pageRefreshButton.setIcon(GWT.getModuleBaseURL()+"admin/images/button/refresh.png");
        pageRefreshButton.setTitle(BLCMain.getMessageManager().getString("restoreTitle"));
        pageRefreshButton.setTooltip(BLCMain.getMessageManager().getString("restoreTooltip"));
        pageRefreshButton.setDisabled(true);
        structuredContentToolBar.addButton(pageRefreshButton);
        structuredContentToolBar.addSpacer(6);
    ...
    public ToolStripButton getRulesSaveButton() {
        return pageSaveButton;
    }

    public void setPageSaveButton(ToolStripButton pageSaveButton) {
        this.pageSaveButton = pageSaveButton;
    }

    @Override
    public ToolStripButton getRulesRefreshButton() {
        return pageRefreshButton;
    }

    public void setPageRefreshButton(ToolStripButton pageRefreshButton) {
        this.pageRefreshButton = pageRefreshButton;
    }
    ...
    public void enableRules() {
        getAddItemButton().setDisabled(false);
        getCustomerFilterBuilder().setDisabled(false);
        getCustomerLabel().setBaseStyle("normalLabel");
        getOrderItemLabel().setBaseStyle("normalLabel");
        getProductFilterBuilder().setDisabled(false);
        getProductLabel().setBaseStyle("normalLabel");
        getRequestFilterBuilder().setDisabled(false);
        getRequestLabel().setBaseStyle("normalLabel");
        getTimeFilterBuilder().setDisabled(false);
        getTimeLabel().setBaseStyle("normalLabel");
    }
