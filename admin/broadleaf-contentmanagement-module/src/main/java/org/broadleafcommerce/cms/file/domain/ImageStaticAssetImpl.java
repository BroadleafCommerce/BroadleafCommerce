...
public class ImageStaticAssetImpl extends StaticAssetImpl implements ImageStaticAsset {
    ...
    @Column(name ="WIDTH")
    @AdminPresentation(friendlyName="ImageStaticAssetImpl_Width", order=1, group = "Image Details", readOnly = true)
    protected Integer width;

    @Column(name ="HEIGHT")
    @AdminPresentation(friendlyName="ImageStaticAssetImpl_Height", order=2, group = "Image Details", readOnly = true)
