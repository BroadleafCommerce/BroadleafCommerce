...
public class CustomCriteriaListGridDataSource extends ListGridDataSource {
    ...
    public CustomCriteriaListGridDataSource(String name, PersistencePerspective persistencePerspective, DynamicEntityServiceAsync service, DataSourceModule[] modules) {
        super(name, persistencePerspective, service, modules);
    }

    public CustomCriteriaListGridDataSource(String name, PersistencePerspective persistencePerspective, DynamicEntityServiceAsync service, DataSourceModule[] modules, boolean useForFetch, boolean useForUpdate, boolean useForAdd, boolean useForRemove, boolean useForInspect) {
        super(name, persistencePerspective, service, modules);
