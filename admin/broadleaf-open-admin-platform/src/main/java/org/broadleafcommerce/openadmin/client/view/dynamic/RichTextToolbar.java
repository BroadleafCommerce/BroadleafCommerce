...
public class RichTextToolbar extends Composite {
	...
	private static final String GUI_HOVERTEXT_HTMLPREVIEW="htmlPreview";
	/** Private Variables **/
	...
	public void insertAsset(String fileExtension, String name, String staticAssetFullUrl) {
		...
		if (fileExtension.equals("gif") || fileExtension.equals("jpg") || fileExtension.equals("png")) {
			...
			if (isHTMLMode()) {
				changeHtmlStyle("<img title='" + name + "' src='" + staticAssetFullUrl + "' alt='" + name,"</img>");
			} else {
