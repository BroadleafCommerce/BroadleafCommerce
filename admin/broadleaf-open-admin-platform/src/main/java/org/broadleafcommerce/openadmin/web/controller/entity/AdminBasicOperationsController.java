...
public class AdminBasicOperationsController extends AdminAbstractController {
    ...
    public String showSelectCollectionItem(
        ...
        PersistencePackageRequest ppr = getSectionPersistencePackageRequest(
                validatedClass, requestParams, sectionCrumbs, pathVars
        );
        ...
        ExtensionResultStatusType extensionResultStatusType = extensionManager.getProxy().buildLookupListGrid(
                ppr, targetClassMetadata, ppr.getCeilingEntityClassname(), sectionCrumbs, model, requestParams
        );
        if (extensionResultStatusType.equals(ExtensionResultStatusType.NOT_HANDLED)) {
            ...
            if (collectionField.contains("|") || dynamicField) {
                ...
                listGrid = formService.buildCollectionListGrid(
                        null, drs, collectionProperty, owningClass, sectionCrumbs
                );
    ...
    public @ResponseBody List<Map<String, String>> getTypeaheadResults(
            HttpServletRequest request,
            HttpServletResponse response,
            Model model,
            @PathVariable Map<String, String> pathVars,
    ...
    public @ResponseBody String sessionTimerReset(
            HttpServletRequest request,
            HttpServletResponse response
    ) throws Exception {
    ...
    public @ResponseBody String logJavaScriptError(
            HttpServletRequest request,
            HttpServletResponse response,
            @RequestParam MultiValueMap<String, String> requestParams
    ) throws Exception {
    ...
    public String updateAdminNavigation(
            HttpServletRequest request,
            HttpServletResponse response,
            Model model,
            @PathVariable Map<String, String> pathVars
