...
public interface FormBuilderService {
     ...
     * @throws ServiceException
     */
    Map<String, Object> buildSelectizeCollectionInfo(String containingEntityId, DynamicResultSet drs, Property field, String sectionKey, List<SectionCrumb> sectionCrumbs)
            throws ServiceException;
    ...
    void populateEntityForm(
            ClassMetadata cmd, Entity entity, Map<String, DynamicResultSet> collectionRecords, EntityForm entityForm,
            List<SectionCrumb> sectionCrumbs
    ) throws ServiceException;
     ...
     * @throws ServiceException
     */
    EntityForm buildAdornedListForm(
            AdornedTargetCollectionMetadata adornedMd, AdornedTargetList adornedList, String parentId,
            boolean isViewCollectionItem, List<SectionCrumb> sectionCrumbs, boolean isAdd
    ) throws ServiceException;
    ...
    EntityForm buildAdornedListForm(
            AdornedTargetCollectionMetadata adornedMd, AdornedTargetList adornedList, String parentId,
            boolean isViewCollectionItem, EntityForm ef, List<SectionCrumb> sectionCrumbs, boolean isAdd
    ) throws ServiceException;
     ...
     * @throws ServiceException
     */
    EntityForm buildMapForm(MapMetadata mapMd, final MapStructure mapStructure, ClassMetadata cmd, String parentId, EntityForm ef) throws ServiceException;
