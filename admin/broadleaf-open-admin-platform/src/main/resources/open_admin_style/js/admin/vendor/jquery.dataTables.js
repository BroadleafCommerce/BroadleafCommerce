	...
	$.extend( true, DataTable.ext.renderer, {
		pageButton: {
			_: function ( settings, host, idx, buttons, page, pages ) {
				...
				var buttonDisplay, buttonClass, counter=0;
					...
					for ( i=0, ien=buttons.length ; i<ien ; i++ ) {
						...
						if ( $.isArray( button ) ) {
							...
							switch ( button ) {
								...
								case 'first':
									buttonDisplay = lang.sFirst;
									buttonClass = button + (page > 0 ?
										'' : ' '+classes.sPageButtonDisabled);
									break;

								case 'previous':
									buttonDisplay = lang.sPrevious;
									buttonClass = button + (page > 0 ?
										'' : ' '+classes.sPageButtonDisabled);
									break;

								case 'next':
									buttonDisplay = lang.sNext;
									buttonClass = button + (page < pages-1 ?
										'' : ' '+classes.sPageButtonDisabled);
									break;

								case 'last':
									buttonDisplay = lang.sLast;
									buttonClass = button + (page < pages-1 ?
										'' : ' '+classes.sPageButtonDisabled);
									break;

								default:
									buttonDisplay = button + 1;
