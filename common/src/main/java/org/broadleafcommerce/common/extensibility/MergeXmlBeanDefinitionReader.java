        ...
        protected void processBeanDefinition(Element ele, BeanDefinitionParserDelegate delegate) {
            ...
            if (existingDefinition != null && isXMLBean(existingDefinition)) {
                ...
                if (bdHolder != null) {
                    ...
                    LOG.info(String.format("Merged the original definition of %s defined as %s with a new definition defined as %s",
                            bdHolder.getBeanName(), existingDefinition, overridingDefinition));
