...
public class JPAPropertiesPersistenceUnitPostProcessor implements org.springframework.orm.jpa.persistenceunit.PersistenceUnitPostProcessor {
    ...
    public void populatePresetProperties() {
        ...
        if (!blPUHibernateNamingImplicitStrategy.startsWith("${"))
            persistenceUnitProperties.put("blPU.hibernate.implicit_naming_strategy", blPUHibernateNamingImplicitStrategy);
        if (!blPUHibernateNamingPhysicalStrategy.startsWith("${"))
            persistenceUnitProperties.put("blPU.hibernate.physical_naming_strategy", blPUHibernateNamingPhysicalStrategy);
        ...
        if (!blCMSStorageHibernateNamingImplicitStrategy.startsWith("${"))
            persistenceUnitProperties.put("blCMSStorage.hibernate.implicit_naming_strategy", blCMSStorageHibernateNamingImplicitStrategy);
        if (!blCMSStorageHibernateNamingPhysicalStrategy.startsWith("${"))
            persistenceUnitProperties.put("blCMSStorage.hibernate.physical_naming_strategy", blCMSStorageHibernateNamingPhysicalStrategy);
        ...
        if (!blSecurePUHibernateNamingImplicitStrategy.startsWith("${"))
            persistenceUnitProperties.put("blSecurePU.hibernate.implicit_naming_strategy", blSecurePUHibernateNamingImplicitStrategy);
        if (!blSecurePUHibernateNamingPhysicalStrategy.startsWith("${"))
            persistenceUnitProperties.put("blSecurePU.hibernate.physical_naming_strategy", blSecurePUHibernateNamingPhysicalStrategy);
