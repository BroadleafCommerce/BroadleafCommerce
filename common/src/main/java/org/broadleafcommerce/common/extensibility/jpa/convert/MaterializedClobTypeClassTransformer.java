...
/**
 * Broadleaf defines the Hibernate type for Clob fields as {@link MaterializedClobType}. This has been deprecated in favor of
                        ...
                        if (AnnotationsAttribute.class.isAssignableFrom(object.getClass())) {
                            ...
                            for (Annotation annotation : items) {
                                ...
                                if (typeName.equals(Type.class.getName())) {
                                    ...
                                    if (annot != null && annot.getValue().equals(MaterializedClobType.class.getName())) {
