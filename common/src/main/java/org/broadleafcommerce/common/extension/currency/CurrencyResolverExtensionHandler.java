 ...
 * 
 * All implementors of this interface should extend the {@link AbstractCurrencyResolverExtensionHandler}
 * where possible.
 * 
 * @author bpolster
 */
public interface CurrencyResolverExtensionHandler extends ExtensionHandler {
     ...
     * @return
     */
    ExtensionResultStatusType overrideCurrency(BroadleafCurrency desiredCurrency,
