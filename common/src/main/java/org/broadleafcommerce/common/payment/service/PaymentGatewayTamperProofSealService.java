...
public interface PaymentGatewayTamperProofSealService {
    ...
    String createTamperProofSeal(String secretKey, String customerId, String orderId)
            throws NoSuchAlgorithmException, InvalidKeyException;

    Boolean verifySeal(String seal, String secretKey, String customerId, String orderId)
