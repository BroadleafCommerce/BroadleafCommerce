...
/**
 * Allows a non-comprehensive override of {@link org.broadleafcommerce.common.presentation.AdminPresentation}
 * property values for a target entity field.
 *
 * @author Jeff Fischer
 */
public @interface AdminPresentationMerge {
     ...
     */
    AdminPresentationMergeEntry[] mergeEntries() default {};
