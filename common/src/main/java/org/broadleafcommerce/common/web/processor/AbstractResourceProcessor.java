...
public abstract class AbstractResourceProcessor extends AbstractBroadleafTagReplacementProcessor {
     ...
     */
    protected abstract BroadleafTemplateModel buildModelUnbundled(
     ...
     * @return model containing resources the tag should be replaced with
     */
    protected abstract BroadleafTemplateModel buildModelBundled(
            List<String> attributeFiles,
            ResourceTagAttributes attributes,
            BroadleafTemplateContext context
    );
     ...
     */
    protected String getFullUnbundledFileName(
            String fileName,
    ...
    protected List<String> postProcessUnbundledFileList(
        ...
        final ResourcesRequestBundle resourcesRequestBundle = resourcesRequest.getBundle(
                tagAttributes.name(), tagAttributes.mappingPrefix(), attributeFiles
        );
        final List<String> filesOnSavedBundle = resourcesRequestBundle == null
                ? null
                : resourcesRequestBundle.getBundleFilePaths();
