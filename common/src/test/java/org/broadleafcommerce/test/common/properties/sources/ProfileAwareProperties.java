 ...
 */
public class ProfileAwareProperties implements BroadleafSharedOverrideProfileAwarePropertySource {

    @Override
    public String getClasspathFolder() {
        return "common-test-properties/profile-aware-properties";
    }
