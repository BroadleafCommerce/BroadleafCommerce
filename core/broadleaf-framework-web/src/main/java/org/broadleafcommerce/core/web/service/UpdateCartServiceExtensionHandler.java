...
public interface UpdateCartServiceExtensionHandler extends ExtensionHandler {
     ...
     * @return
     */
    ExtensionResultStatusType updateAndValidateCart(Order cart, ExtensionResultHolder resultHolder);
     ...
     */
    ExtensionResultStatusType validateAddToCartItem(OrderItemRequestDTO itemRequest, Order cart) throws IllegalArgumentException;
