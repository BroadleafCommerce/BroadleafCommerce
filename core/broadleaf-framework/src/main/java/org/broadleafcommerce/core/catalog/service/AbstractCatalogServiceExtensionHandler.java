 ...
 */
public abstract class AbstractCatalogServiceExtensionHandler extends AbstractExtensionHandler implements CatalogServiceExtensionHandler {
    ...
    @Override
    public ExtensionResultStatusType findProductByURI(
            CatalogContextDTO context,
            String uri,
    ...
    @Override
    public ExtensionResultStatusType findCategoryByURI(
            CatalogContextDTO context,
            String uri,
            ExtensionResultHolder resultHolder
    ) {
    ...
    @Override
    public ExtensionResultStatusType findSkuByURI(
            CatalogContextDTO context,
            String uri,
            ExtensionResultHolder resultHolder
    ) {
