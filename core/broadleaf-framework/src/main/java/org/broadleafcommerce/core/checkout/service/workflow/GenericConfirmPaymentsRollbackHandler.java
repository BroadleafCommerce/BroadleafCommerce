 ...
 */
public class GenericConfirmPaymentsRollbackHandler<T extends CheckoutResponse> implements RollbackHandler<T> {

    protected static final Log LOG = LogFactory.getLog(GenericConfirmPaymentsRollbackHandler.class);
    ...
    @Override
    public void rollbackState(Activity<? extends ProcessContext<T>> activity, ProcessContext<T> processContext, Map<String, Object> stateConfiguration) throws RollbackFailureException {
        T seed = processContext.getSeedData();
