...
public interface OfferCodeDaoExtensionHandler extends ExtensionHandler {
     ...
     * @return
     */
    ExtensionResultStatusType createReadOfferCodeByCodeQuery(EntityManager em, ExtensionResultHolder<Query> resultHolder,
                                                             String code, boolean cacheable, String cacheRegion);
