...
@DirectCopyTransform({
        @DirectCopyTransformMember(templateTokens = DirectCopyTransformTypes.SANDBOX, skipOverlaps = true, indexes = {@javax.persistence.Index(name = "CANDIDATE_FG_INDEX", columnList = "FULFILLMENT_GROUP_ID"),
                @javax.persistence.Index(name = "CANDIDATE_FGOFFER_INDEX", columnList = "OFFER_ID")})
})
