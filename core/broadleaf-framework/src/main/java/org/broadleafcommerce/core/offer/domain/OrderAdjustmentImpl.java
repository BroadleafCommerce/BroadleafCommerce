...
@DirectCopyTransform({
        @DirectCopyTransformMember(templateTokens = DirectCopyTransformTypes.SANDBOX, skipOverlaps = true, indexes = {@javax.persistence.Index(name = "ORDERADJUST_ORDER_INDEX", columnList = "ORDER_ID"),
                @javax.persistence.Index(name = "ORDERADJUST_OFFER_INDEX", columnList = "OFFER_ID")})
})
