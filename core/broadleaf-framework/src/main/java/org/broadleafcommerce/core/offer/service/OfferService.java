...
public interface OfferService {
     ...
     */
    public boolean verifyMaxCustomerUsageThreshold(@Nonnull Long customerExternalId, @Nonnull Offer offer);
     ...
     * @return <b>true</b> if it is ok for the customer to use this offer with their current order, <b>false</b> if not.
     */
    public boolean verifyMaxCustomerUsageThreshold(@Nonnull Long customerExternalId, @Nonnull OfferCode code);
