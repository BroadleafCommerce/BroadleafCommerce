...
public class PromotableOrderItemImpl implements PromotableOrderItem {
    ...
    protected List<PromotableOrderItemAdjustment> candidateItemOfferAdjustments = new ArrayList<PromotableOrderItemAdjustment>();
    protected Money retailAdjustmentPrice;
    protected Money saleAdjustmentPrice;
    ...
    @Override
    public List<PromotableOrderItemAdjustment> getCandidateItemAdjustments() {
        return candidateItemOfferAdjustments;
    }

    @Override
    public void addOrderItemAdjustments(PromotableOrderItemAdjustment itemAdjustment) {
    ...
    public void computeAdjustmentPrice() {
        // TODO:  Get base retail and base sale price
