 ...
 *
 */
public abstract class LegacyAbstractBaseProcessor implements BaseProcessor {

	private static final Log LOG = LogFactory.getLog(LegacyAbstractBaseProcessor.class);
