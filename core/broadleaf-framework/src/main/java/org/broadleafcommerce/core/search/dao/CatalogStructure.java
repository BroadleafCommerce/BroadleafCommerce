...
public class CatalogStructure implements Serializable {
    ...
    protected Map<Long, Set<Long>> parentCategoriesByProduct = Collections.synchronizedMap(new HashMap<Long, Set<Long>>());
    protected Map<Long, Set<Long>> parentCategoriesByCategory = Collections.synchronizedMap(new HashMap<Long, Set<Long>>());
    protected Map<Long, List<Long>> productsByCategory = Collections.synchronizedMap(new HashMap<Long, List<Long>>());
    protected Map<String, BigDecimal> displayOrdersByCategoryProduct = Collections.synchronizedMap(new HashMap<String, BigDecimal>());
