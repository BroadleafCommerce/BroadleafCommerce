...
/**
 * Interface that defines a method to accept an indexable instance and return a search engine-specific input (document).
 * 
...
public interface DocumentBuilder<I extends Indexable, D> {
     ...
     * accept a {@link Product} and return a SolrInputDocument.
     * 
     * @param indexable
     * @return
     */
