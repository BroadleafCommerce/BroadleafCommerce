...
public interface SolrIndexService {
     ...
     * @throws ServiceException
     */
    void preBuildIndex() throws ServiceException;
     ...
     */
    void buildIndex() throws IOException, ServiceException;
     ...
     * @throws ServiceException
     */
    void postBuildIndex() throws IOException, ServiceException;
     ...
     * @throws IOException
     */
    void executeSolrIndexOperation(SolrIndexOperation operation) throws ServiceException, IOException;
     ...
     * @throws ServiceException
     */
    Collection<SolrInputDocument> buildIncrementalIndex(String collection, List<? extends Indexable> indexables, SolrClient solrServer) throws ServiceException;
     ...
     */
    @Deprecated
    Collection<SolrInputDocument> buildIncrementalIndex(List<? extends Indexable> indexables, SolrClient solrServer) throws ServiceException;
     ...
     * @throws IOException
     */
    void commit(String collection, SolrClient server) throws ServiceException, IOException;
     ...
     */
    @Deprecated
    void commit(SolrClient server) throws ServiceException, IOException;
     ...
     * @throws IOException
     */
    void commit(String collection, SolrClient server, boolean softCommit, boolean waitSearcher, boolean waitFlush) throws ServiceException, IOException;
     ...
     */
    @Deprecated
    void commit(SolrClient server, boolean softCommit, boolean waitSearcher, boolean waitFlush) throws ServiceException, IOException;

    void deleteAllNamespaceDocuments(String collection, SolrClient server) throws ServiceException;
     ...
     */
    @Deprecated
    void deleteAllNamespaceDocuments(SolrClient server) throws ServiceException;

    void deleteAllDocuments(String collection, SolrClient server) throws ServiceException;
     ...
     */
    @Deprecated
    void deleteAllDocuments(SolrClient server) throws ServiceException;
     ...
     * @param documents
     */
    void logDocuments(Collection<SolrInputDocument> documents);
     ...
     * @return the document
     */
    SolrInputDocument buildDocument(Indexable indexable, List<IndexField> fields, List<Locale> locales);
     ...
     * @param locales
     */
    void attachIndexableDocumentFields(SolrInputDocument document, Indexable indexable, List<IndexField> fields, List<Locale> locales);
