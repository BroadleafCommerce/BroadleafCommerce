...
public class ReindexStateHolder {
    ...
    private static final Map<String, ReindexStateHolder> STATE_HOLDER_REGISTRY = Collections.synchronizedMap(new HashMap<>());
    private final String collectionName;
    private final boolean incrementalCommits;
    private final Map<String, Object> additionalState = Collections.synchronizedMap(new HashMap<>());
