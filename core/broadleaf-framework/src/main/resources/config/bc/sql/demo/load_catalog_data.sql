...
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE,DISPLAY_TEMPLATE,ROOT_DISPLAY_ORDER) VALUES (2001,'Home','Home','/',CURRENT_TIMESTAMP, 'layout/home', -5.000000);
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE,ROOT_DISPLAY_ORDER) VALUES (2002,'Hot Sauces','Hot Sauces','/hot-sauces',CURRENT_TIMESTAMP, -4.000000);
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE,ROOT_DISPLAY_ORDER) VALUES (2003,'Merchandise','Merchandise','/merchandise',CURRENT_TIMESTAMP, -3.000000);
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE,ROOT_DISPLAY_ORDER) VALUES (2004,'Clearance','Clearance','/clearance',CURRENT_TIMESTAMP, -2.000000);
...
INSERT INTO BLC_SKU_BUNDLE_ITEM (SKU_BUNDLE_ITEM_ID,QUANTITY,PRODUCT_BUNDLE_ID,SKU_ID,SEQUENCE) VALUES (-100, 1, 20, 1,1);
INSERT INTO BLC_SKU_BUNDLE_ITEM (SKU_BUNDLE_ITEM_ID,QUANTITY,PRODUCT_BUNDLE_ID,SKU_ID,SEQUENCE) VALUES (-101, 1, 20, 2,2);
--bundle2
...
INSERT INTO BLC_SKU_BUNDLE_ITEM (SKU_BUNDLE_ITEM_ID,QUANTITY,PRODUCT_BUNDLE_ID,SKU_ID,SEQUENCE) VALUES (-102, 1, 21, 1,2);
INSERT INTO BLC_SKU_BUNDLE_ITEM (SKU_BUNDLE_ITEM_ID,QUANTITY,PRODUCT_BUNDLE_ID,SKU_ID,SEQUENCE) VALUES (-103, 1, 21, 2,1);
...
INSERT INTO BLC_OFFER (OFFER_ID, OFFER_NAME, START_DATE, END_DATE, OFFER_TYPE, OFFER_DISCOUNT_TYPE, OFFER_VALUE, COMBINABLE_WITH_OTHER_OFFERS, APPLY_TO_SALE_PRICE, MAX_USES, OFFER_TEMPLATE_ID, OFFER_TIMEZONE_TYPE, OFFER_ITEM_TARGET_RULE, AUTOMATICALLY_ADDED, HAS_PROMOTION_MESSAGE, OFFER_PRORATION_TYPE, APPLY_TO_CHILD_ITEMS) VALUES (1, 'Shirts Special',CURRENT_DATE,'2020-01-01 00:00:00','ORDER_ITEM','PERCENT_OFF',20,TRUE,FALSE,0,-14101,'SERVER', 'NONE', FALSE, FALSE,'TARGET_ONLY',FALSE);
...
INSERT INTO BLC_OFFER_ITEM_CRITERIA (OFFER_ITEM_CRITERIA_ID, ORDER_ITEM_MATCH_RULE, QUANTITY) VALUES (1, 'CollectionUtils.intersection(orderItem.embeddableMerchandisingGroupOrderItem.applicableMerchandisingCategory, [\"2003\"]).size()>0', 1);
