...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-502, 2002, 'zh_CN', 'Category', 'name', '酱汁');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-503, 2003, 'zh_CN', 'Category', 'name', '衣柜');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-513, 2003, 'zh_CN', 'Category', 'description', '衣柜');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-555, 3, 'zh_CN', 'Sku', 'name', '辣酱料斗');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-556, 3, 'zh_CN', 'Sku', 'longDescription', '辛辣的辣椒酱，配上大蒜、洋葱、番茄酱和少许甘蔗糖，做成油腻的酱汁。在鸡蛋、家禽、猪或鱼上做得很好，这种玛丽酱可以用来做腌料和浓汤。');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-557, 4, 'zh_CN', 'Sku', 'name', '热酱汁');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-559, 5, 'zh_CN', 'Sku', 'name', '哈瓦那辣酱');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-561, 6, 'zh_CN', 'Sku', 'name', '苏格兰辣酱');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-564, 7, 'zh_CN', 'Sku', 'longDescription', 'Fabriqué与Naga Bhut Jolokia，世界上最辣的胡椒。');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-569, 10, 'zh_CN', 'Sku', 'name', '奇列梅斯特博士辣酱疯了');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-571, 11, 'zh_CN', 'Sku', 'name', '牛鼻子牛仔辣椒辣酱');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-573, 12, 'zh_CN', 'Sku', 'name', 'Café路易斯安那州卡真甜酱变黑');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-575, 13, 'zh_CN', 'Sku', 'name', '牛鼻烟辣酱扁桃体');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-576, 13, 'zh_CN', 'Sku', 'longDescription', '在德克萨斯州，一切都更大，即使是辛辣的浮丁牛酱!在德克萨斯州，一切都更大了，甚至是辣酱烫伤了一头公牛!在德州牛排上淋浴，他们称之为“96er Ole”或“你的蔬菜简飞机”。如果你是烧烤酱的粉丝像我一样从头开始，你可以用牛扁桃体鼻烟辣酱作为添加剂。红辣椒和辣椒这种扁桃体刺痛有一种著名的热红色的味道。布尔鼻烟“热扁桃体酱”会让你的内脏变白，只需一滴水。');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-578, 14, 'zh_CN', 'Sku', 'longDescription', '这种酱汁的味道来自古老的辣椒和甘蔗醋。它将改善大多数食物的味道。');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-579, 15, 'zh_CN', 'Sku', 'name', 'à酱;烤大蒜');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-580, 15, 'zh_CN', 'Sku', 'longDescription', '这种酱汁的味道来自古老的辣椒和甘蔗醋。它将改善大多数食物的味道。');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-581, 16, 'zh_CN', 'Sku', 'name', '苏格兰软帽');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-582, 16, 'zh_CN', 'Sku', 'longDescription', '这种酱汁的味道来自古老的辣椒和甘蔗醋。它将改善大多数食物的味道。');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-583, 17, 'zh_CN', 'Sku', 'name', '苏格兰软帽');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-584, 17, 'zh_CN', 'Sku', 'longDescription', '这种酱汁的味道来自古老的辣椒和甘蔗醋。它将改善大多数食物的味道。');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-585, 18, 'zh_CN', 'Sku', 'name', '苏格兰软帽');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-587, 19, 'zh_CN', 'Sku', 'name', '苏格兰软帽');
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-588, 19, 'zh_CN', 'Sku', 'longDescription', '这种酱汁的味道来自古老的辣椒和甘蔗醋。它将改善大多数食物的味道。');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-681, 2, 'zh_CN', 'SearchFacet', 'label', 'Degré热');
