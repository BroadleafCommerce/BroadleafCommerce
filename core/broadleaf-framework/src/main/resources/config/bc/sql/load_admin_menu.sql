...
-- Fulfillment Options
INSERT INTO BLC_ADMIN_SECTION (ADMIN_SECTION_ID, DISPLAY_ORDER, ADMIN_MODULE_ID, NAME, SECTION_KEY, URL, CEILING_ENTITY) VALUES (-18, 3000, -9, 'Fulfillment Options', 'FulfillmentOption', '/fulfillment-option', 'org.broadleafcommerce.core.order.domain.FulfillmentOption');
...
-- Fulfillment Options
INSERT INTO BLC_ADMIN_SEC_PERM_XREF (ADMIN_SECTION_ID, ADMIN_PERMISSION_ID) VALUES (-18,-170);
INSERT INTO BLC_ADMIN_SEC_PERM_XREF (ADMIN_SECTION_ID, ADMIN_PERMISSION_ID) VALUES (-18,-171);