...
class DecrementInventoryRollbackHandlerSpec extends BaseCheckoutRollbackSpec{
	...
	def"Test that RollbackFailureException is thrown when attempting to increment inventory"(){
		...
		ex.message.equals("An unexpected error occured in the error handler of the checkout workflow trying to compensate for inventory. This happend for order ID: 1. This should be corrected manually!")
	...
	def"Test that RollbackFailureException occured due to RuntimeException when attempting to decrement inventory"(){
		...
		RollbackFailureException ex = thrown(RollbackFailureException)
		ex.message.equals("An unexpected error occured in the error handler of the checkout workflow trying to compensate for inventory. This happend for order ID: 3. This should be corrected manually!")
