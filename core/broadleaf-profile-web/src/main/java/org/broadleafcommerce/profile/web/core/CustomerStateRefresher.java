    ...
    public void onApplicationEvent(final CustomerPersistedEvent event) {
        ...
        if (request != null) {
            ...
            if (BLCRequestUtils.isOKtoUseSession(request)) {
                ...
                //persisted
                if (sessionCustomer != null && (sessionCustomer.getId() == null
                        || sessionCustomer.getId().equals(dbCustomer.getId()))) {
            ...
            if (CustomerState.getCustomer() != null && CustomerState.getCustomer().getId() != null
                    && CustomerState.getCustomer().getId().equals(dbCustomer.getId())) {
