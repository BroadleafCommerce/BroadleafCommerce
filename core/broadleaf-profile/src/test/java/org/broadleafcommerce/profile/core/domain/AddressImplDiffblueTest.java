...
public class AddressImplDiffblueTest {
  ...
  public void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("0987654321", actualSecondaryPhone);
    assertEquals("10001", actualPostalCode);
    assertEquals("1122334455", actualFax);
    assertEquals("123 Main St", actualAddressLine1);
    assertEquals("1234", actualZipFour);
    assertEquals("1234567890", actualPrimaryPhone);
    assertEquals("Apt 4B", actualAddressLine2);
    assertEquals("Doe", actualLastName);
    assertEquals("Example Company", actualCompanyName);
    assertEquals("John Doe", actualFullName);
    assertEquals("John", actualFirstName);
    assertEquals("Level 1", actualVerificationLevel);
    assertEquals("Manhattan", actualCounty);
    assertEquals("NY", actualStateProvinceRegion);
    assertEquals("New York", actualCity);
    assertEquals("Suite 100", actualAddressLine3);
    assertEquals("US", actualIsoCountrySubdivision);
    assertEquals("john.doe@example.com", actualEmailAddress);
    assertEquals("token123", actualTokenizedAddress);
    assertEquals(1L, actualId.longValue());
    assertFalse(actualStandardized);
    assertFalse(actualIsBusinessResult);
    assertFalse(actualIsMailingResult);
  ...
  public void testGetPhonePrimary_givenAddressImplPhonePrimaryIsNull_thenReturnPhoneImpl() {
    ...
    addressImpl2.setAddressLine1("123 Main St");
    addressImpl2.setAddressLine2("Apt 4B");
    addressImpl2.setAddressLine3("Suite 100");
    addressImpl2.setBusiness(false);
    addressImpl2.setCity("New York");
    addressImpl2.setCompanyName("Example Company");
    addressImpl2.setCountry(new CountryImpl());
    addressImpl2.setCounty("Manhattan");
    addressImpl2.setDefault(true);
    addressImpl2.setEmailAddress("john.doe@example.com");
    addressImpl2.setFax("1122334455");
    addressImpl2.setFirstName("John");
    addressImpl2.setFullName("John Doe");
    addressImpl2.setId(1L);
    addressImpl2.setIsoCountryAlpha2(new ISOCountryImpl());
    addressImpl2.setIsoCountrySubdivision("US");
    addressImpl2.setLastName("Doe");
    addressImpl2.setMailing(false);
    addressImpl2.setPhoneFax(new PhoneImpl());
    addressImpl2.setPhoneSecondary(new PhoneImpl());
    addressImpl2.setPostalCode("10001");
    addressImpl2.setSecondaryPhone("0987654321");
    addressImpl2.setStandardized(false);
    addressImpl2.setState(new StateImpl());
    addressImpl2.setStateProvinceRegion("NY");
    addressImpl2.setStreet(true);
    addressImpl2.setTokenizedAddress("token123");
    addressImpl2.setVerificationLevel("Level 1");
    addressImpl2.setZipFour("1234");
  ...
  public void testGetPhoneSecondary_givenAddressImplPhoneSecondaryIsNull_thenReturnPhoneImpl() {
    ...
    addressImpl2.setPostalCode("10001");
    addressImpl2.setPrimaryPhone("1234567890");
    addressImpl2.setStandardized(false);
    addressImpl2.setState(new StateImpl());
    addressImpl2.setStateProvinceRegion("NY");
    addressImpl2.setStreet(true);
