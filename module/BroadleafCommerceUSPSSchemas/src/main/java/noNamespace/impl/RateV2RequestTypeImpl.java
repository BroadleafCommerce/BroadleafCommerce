 ...
 */
public class RateV2RequestTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements noNamespace.RateV2RequestType
{
    private static final long serialVersionUID = 1L;
    
    public RateV2RequestTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public noNamespace.RequestPackageV2Type[] getPackageArray()
    {
        synchronized (monitor())
        {
            ...
            noNamespace.RequestPackageV2Type[] result = new noNamespace.RequestPackageV2Type[targetList.size()];
     ...
     */
    public noNamespace.RequestPackageV2Type getPackageArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            noNamespace.RequestPackageV2Type target = null;
            target = (noNamespace.RequestPackageV2Type)get_store().find_element_user(PACKAGE$0, i);
            if (target == null)
            {
     ...
     */
    public void setPackageArray(noNamespace.RequestPackageV2Type[] xpackageArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setPackageArray(int i, noNamespace.RequestPackageV2Type xpackage)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public noNamespace.RequestPackageV2Type insertNewPackage(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            noNamespace.RequestPackageV2Type target = null;
            target = (noNamespace.RequestPackageV2Type)get_store().insert_element_user(PACKAGE$0, i);
            return target;
        }
    }
     ...
     */
    public noNamespace.RequestPackageV2Type addNewPackage()
    {
        synchronized (monitor())
        {
            check_orphaned();
            noNamespace.RequestPackageV2Type target = null;
            target = (noNamespace.RequestPackageV2Type)get_store().add_element_user(PACKAGE$0);
            return target;
        }
    }
