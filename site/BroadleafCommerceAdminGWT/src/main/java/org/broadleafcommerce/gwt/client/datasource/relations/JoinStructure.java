...
public class JoinStructure implements Serializable, PersistencePerspectiveItem {
	...
	public JoinStructure(String manyToField, String linkedObjectPath, String linkedIdProperty, String targetObjectPath, String targetIdProperty, String joinStructureEntityClassname) {
		this(manyToField, linkedObjectPath, linkedIdProperty, targetObjectPath, targetIdProperty, joinStructureEntityClassname, null, null);
	}
	
	public JoinStructure(String manyToField, String linkedObjectPath, String linkedIdProperty, String targetObjectPath, String targetIdProperty, String joinStructureEntityClassname, String sortField, Boolean sortAscending) {
