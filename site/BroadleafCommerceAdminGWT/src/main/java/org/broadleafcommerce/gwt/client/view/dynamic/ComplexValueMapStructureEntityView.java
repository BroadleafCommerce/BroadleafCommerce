...
public class ComplexValueMapStructureEntityView extends DynamicEntityView {
	
	protected MapStructure mapStructure;
	protected LinkedHashMap<String, String> mapKeys;

	public ComplexValueMapStructureEntityView(MapStructure mapStructure, LinkedHashMap<String, String> mapKeys) {
		super();
