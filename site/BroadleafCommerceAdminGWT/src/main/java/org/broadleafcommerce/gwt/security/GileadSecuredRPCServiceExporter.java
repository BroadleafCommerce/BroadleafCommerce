 ...
 * @author jfischer
 */
public class GileadSecuredRPCServiceExporter extends GileadRPCServiceExporter {

	/** serialVersionUID */
	private static final long serialVersionUID = 2733022902422767233L;

	/** logger. */
	private final static Logger LOGGER = Logger.getLogger(GileadSecuredRPCServiceExporter.class);
