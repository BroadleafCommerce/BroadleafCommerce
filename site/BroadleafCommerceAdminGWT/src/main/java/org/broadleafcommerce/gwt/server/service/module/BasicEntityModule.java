		...
		for (Property property : entity.getProperties()) {
			...
			if (value != null && mergedProperties.get(property.getName()) != null) {
				...
				case EMAIL :
					...
					break;
				case FOREIGN_KEY :{
					Serializable foreignInstance = dynamicEntityDao.retrieve(Class.forName(mergedProperties.get(property.getName()).getForeignKeyClass()), Long.valueOf(value));
				...
				if (isFieldAccessible) {
			    	...
			    	if (value == null) {
			        	...
			        	//} else if (entity.getClass().equals(value.getClass()) && idProperty != null){
			        		...
			        		Object temp = fieldManager.getFieldValue(value, "name");
			        		if (temp != null) {
