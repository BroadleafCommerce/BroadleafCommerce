...
INSERT INTO BLC_ADMIN_USER (ADMIN_USER_ID, EMAIL, LOGIN, NAME, PASSWORD) VALUES (2,'admin_promo@yourdomain.com','promotion_manager','Promotion Manager','blc_admin');

INSERT INTO BLC_ADMIN_ROLE (ADMIN_ROLE_ID, DESCRIPTION, NAME) VALUES (1,'Admin Master Access','ROLE_ADMIN');

INSERT INTO BLC_ADMIN_ROLE (ADMIN_ROLE_ID, DESCRIPTION, NAME) VALUES (2,'Promotion Manager','ROLE_PROMOTION_MANAGER');

INSERT INTO BLC_ADMIN_PERMISSION (ADMIN_PERMISSION_ID, DESCRIPTION, NAME) VALUES (1,'Default Permission','PERMISSION_DEFAULT');

INSERT INTO BLC_ADMIN_PERMISSION (ADMIN_PERMISSION_ID, DESCRIPTION, NAME) VALUES (2,'View Offer Section Permission','PERMISSION_VIEW_OFFER_SECTION');

INSERT INTO BLC_ADMIN_PERMISSION (ADMIN_PERMISSION_ID, DESCRIPTION, NAME) VALUES (3,'Edit Offer Description Permission','PERMISSION_EDIT_OFFER_DESCRIPTION');
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (128,'DeLonghi - 14 Cup Drip Coffee Maker','24-hour programmable timer is convenient and easy-to-use. Just set the timer the night before, and wake up to the aroma of fresh brewed coffee. Internal water level indicator lets you know how much water is in the tank. Permanent gold-tone filter durab',198.99,198.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (129,'DeLonghi - 12-Cup Drip Coffee Maker w/ Frontal Access','24-hour programmable digital timer with 2 hour automatic shut-off. Water level indicator lets you know when the unit needs refilling. Permanent gold-tone filter durable and long lasting, the gold-tone filter is specially designed to keep even the fines',149.99,149.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (130,'Capresso - Coffee Team Therm Grind/Brew Coffeemaker Kit','Perfect for the brewed coffee connoisseur, the programmable 10-cup capacity Capresso CoffeeTEAM is the only combination machine with a conical burr grinder and a stainless steel thermal carafe. Just pour in the beans, program the time and the amount of',183.99,181.99,'N','N','2020-01-01',CURRENT_DATE);
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (133,'Bodum - Cafe Solo - Filtre Belgique','The design of the Filter Belgique is itself done with a "silent attitude", but the product incorporates a high content of design details which make it simple to use and nice to look at. In this way, it stands out from most of the same type of mass-mark',79.99,77.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (134,'DeLonghi - Perfecta Fully Automatic Expresso Machine','Easy to use control panel with digital programmable menu settings allow you to adjust start time, auto shut and off and clock. You can adjust temperature of the coffee and water hardness. Plus, there are five settings for coffee strength: extra-mild, m',43.99,41.99,'N','N','2020-01-01',CURRENT_DATE);
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (145,'Jura - Capresso Impressa Z5 Espresso Machine Kit','This super automatic espresso machine lets you go from whole beans to superb espresso and any size cappuccino or latte with one-touch convenience. Programmable brewing buttons let you select your coffeeâs size, strength and temperature. Built-in comme',182.99,182.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (146,'Pasquini - Livietta Espresso Machine Kit','Compact and semi-automatic, Pasquini''s latest commercial machine for the home fits beautifully in almost any size kitchen. New thermoblock technology lets you steam milk and brew espresso at the same timeâmaking it ideal for entertaining. Use with illy',151.99,151.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (147,'Gaggia - Titanium Espresso Machine Kit','This super automatic, all-in-one home cafe machine makes espresso, cappuccino and latte almost instantly. Fully programmable with three brewing buttons to dispense any amount of coffee you like, plus a built-in professional burr grinder and two superb ',179.99,177.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (148,'Saeco - Magic Cappuccino Espresso Machine Kit','This is a terrific machine that uses a patented nickel plated brass pressurized portfilter to ensure a great espresso extraction. It works by pressurizing the brewing chamber through a small spring-loaded valve located below the filter basket. The valv',144.99,142.99,'N','N','2020-01-01',CURRENT_DATE);
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (150,'Saeco - Magic Cappuccino Espresso Machine Kit','This is a terrific machine that uses a patented nickel plated brass pressurized portfilter to ensure a great espresso extraction. It works by pressurizing the brewing chamber through a small spring-loaded valve located below the filter basket. The valv',71.99,69.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (151,'Pasquini - Livia 90P Espresso Machine Kit','The ultimate gift for the discriminating espresso connoisseur and home barista. This kit includes the Pasquini Livia 90, the top-of-the-line espesso machine whose commercial-grade quality and design make it the very best semi-automatic home machine ',73.99,73.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (152,'Kitchenaid - ProLine Espresso Machine Kit','The Kitchenaid Pro Line is a high-performance professional espresso machine designed for the home. Based on models used in Italian coffee bars, this stylish commercial-grade machine has dual boilers that let you brew espresso and steam milk with no',75.99,73.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (153,'Illy - FrancisFrancis X6 Trio Espresso Machine Kit','From renowned Italian espresso machine maker francis francis and architect Luca Trazzi, the X6 features an 18 Bar pressure pump and unique Trio Technology that makes three espresso preparations: short (ristretto), normal(espresso) and long (espresso lu',187.99,185.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (154,'Illy - FrancisFrancis X8 iperEspresso Machine Kit','Designed to work exclusively with illy iperEspresso capsules, the state-of-the-art Francis Francis X8 iperEspresso machine makes extraordinary espresso with one-touch convenience. Unlike conventional one-stage systems, the iperEspresso method uses an i',133.99,131.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (155,'Illy - FrancisFrancis X7 iperEspresso Machine Kit','Designed to work exclusively with illy iperEspresso capsules, the striking Francis Francis X7 makes extraordinary espresso with one-touch convenience. Unlike conventional one-stage systems, the iperEspresso method uses an innovative, patented two-stage',68.99,68.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (156,'DeLonghi - Magnifica Super Automatic Espresso Machine Kit','The Delonghi Magnifica lets you brew fresh, aromatic espresso or coffee from beans freshly ground in the professional-quality, lower-pitch conical burr grinder. What you grind is what you brew. The compact and patented Direct-to-Brew System with Thermo',167.99,167.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (157,'Saeco - Odea Giro Super Automatic Espresso Machine kit','Designed by BMW DesignworksUSA, the new Saeco Odea super automatic espresso machine lets you easily brew high-quality espresso and cappuccino at home. Featuring Saeco''s innovative Giro interface display with simplified programming, this super automatic',129.99,127.99,'N','N','2020-01-01',CURRENT_DATE);
...
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (160,'Saeco - Nina Bar','The top level machine in the Nina line, Nina Bar features an innovative new interface that allows for more brewing control. With the push of a button you can program the electronic dosing system and control the amount of coffee brewed. Once programming',66.99,64.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (161,'Saeco - Aroma','This traditional Italian-made espresso machine is a great addition to any kitchen. Featuring a sturdy all-metal body, this machine is designed to last. The steam wand allows you to froth milk quickly and easily, and even dispenses hot water for tea. Cr',40.99,40.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (162,'Saeco - Odea Giro Orange','Part of the new Odea line designed by BMW DesignworksUSA, the Odea Giro features Saeco''s latest innovations including a Giro (dial) interface, ceramic disc grinder, drip tray with manual Touch Lift technology, and OptiDose, to adjust the',147.99,145.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (163,'Saeco - Talea Touch','Part of the new Talea line designed by BMW DesignworksUSA, the Talea Touch features Saeco''s latest innovations including a large touch screen interface, SBS Saeco Brewing System, ceramic disc grinder and motorized drip tray with Touch Lift',152.99,150.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (164,'Saeco - Primea Ring','Designed exclusively by BMW Group DesignworksUSA, the Primea Ring is a masterpiece in design, and the latest in luxury for your home. Thanks to superior innovations in technology, the Primea Ring prepares espresso with a perfect crema, aroma and flavor',175.99,175.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (165,'Saeco - Royal Coffee Bar','The Royal Coffee Bar, stylish and sleek in silver and graphite, is sure to be an eye catcher in any kitchen or office. With the simple push button technology the machine will grind, tamp, and dispense espresso/coffee with a rich creamy crema. The digit',171.99,169.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (166,'Saeco - Incanto Classic','Part of the Incanto family of automatic machines, the Incanto Classic features innovative Saeco technologies including 2 programmable beverage settings, Saeco OptiDose and built-in burr grinder. With the Saeco Brewing System, or SBS, the Classic makes ',193.99,191.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (167,'Saeco - Espresso Italiano','Bringing the cafÃ© into your own home has never been easier than with the Espresso Italiano. Just add whole beans and water, and instantly you will have a perfectly extracted espresso. With state-of-the-art technology, including a tri-colored digital',75.99,75.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (168,'Saeco - Spidem Villa','The Villa Silver puts Saecoâs patented removable brew group technology into an easy-to-use interface. You can now make espressos, cappuccinos, lattes, and tea all from one machine that grinds, tamps, and brews gourmet coffee. The pump driven steam and',56.99,56.99,'N','N','2020-01-01',CURRENT_DATE);
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (169,'Jura - ENA 5','The new contemporary design is less than 9Ã½ inches wide, freeing up counter space while offering a true bean-to-cup experience. The new rotary switch makes the ENA the easiest to use automatic coffee center. The patent-pending Zero-Energy-Technology',41.99,39.99,'N','N','2020-01-01',CURRENT_DATE);
...
--other sku
INSERT INTO BLC_SKU (SKU_ID,NAME,DESCRIPTION,RETAIL_PRICE,SALE_PRICE,TAXABLE_FLAG,DISCOUNTABLE_FLAG,ACTIVE_END_DATE,ACTIVE_START_DATE) VALUES (200,'Test Product','Test Product Description',1,1,'N','N','2020-01-01',CURRENT_DATE);
