...
INSERT INTO BLC_PAGE_TMPLT (PAGE_TMPLT_ID, LOCALE_ID, TMPLT_NAME, TMPLT_DESCR, TMPLT_PATH) VALUES (1, 1, 'Basic Template', 'This template provides a basic layout with header and footer surrounding the content.', '/basic') ;
INSERT INTO BLC_PAGE_TMPLT (PAGE_TMPLT_ID, LOCALE_ID, TMPLT_NAME, TMPLT_DESCR, TMPLT_PATH) VALUES (2, 1, 'Blank Template', 'Use this template to completely control the page contents.', '/blank') ;
INSERT INTO BLC_PAGE_TMPLT (PAGE_TMPLT_ID, LOCALE_ID, TMPLT_NAME, TMPLT_DESCR, TMPLT_PATH) VALUES (3, 2, 'Basico Template', 'This template provides a basic layout with header and footer surrounding the content.', '/basic') ;
INSERT INTO BLC_PAGE_TMPLT (PAGE_TMPLT_ID, LOCALE_ID, TMPLT_NAME, TMPLT_DESCR, TMPLT_PATH) VALUES (4, 2, 'En Blanco Template', 'Use this template to completely control the page contents.', '/blank') ;
...
-- Structured Content
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_ID, SC_TYPE_ID) VALUES (100, false, 1, CURRENT_DATE, CURRENT_DATE, 1, 'Havalatta Banner Ad', false, false, 5, 1, 1);
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_ID, SC_TYPE_ID) VALUES (101, false, 1, CURRENT_DATE, CURRENT_DATE, 1, '40% off Mugs', false, false, 5, 1, 2);
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_ID, SC_TYPE_ID) VALUES (102, false, 1, CURRENT_DATE, CURRENT_DATE, 1, 'French Roast 20% off', false, false, 6, 1, 2);
...
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_ID, SC_TYPE_ID) VALUES (120, false, 1, CURRENT_DATE, CURRENT_DATE, 1, 'Home Page Message', false, false, 5, 1, 3);
