...
public interface OfferService {
    ...
    /**
     * Consume offer. This method is used at order submit time to finalize the offers that are used.
     * Until this method is called all offers are not used and may be used again if the order is
     * not submitted and the offers not consumed.
     * 
