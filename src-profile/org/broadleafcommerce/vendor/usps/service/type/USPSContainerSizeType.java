 ...
 * @author jfischer
 */
public class USPSContainerSizeType implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final Map<String, USPSContainerSizeType> types = new Hashtable<String, USPSContainerSizeType>();
    ...
    public static USPSContainerSizeType getInstance(String type) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        USPSContainerSizeType other = (USPSContainerSizeType) obj;
        if (type == null) {
            if (other.type != null)
                return false;
